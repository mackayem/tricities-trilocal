/*!
  * Understrap v1.1.0 (https://www.trilocal.ca)
  * Copyright 2013-2022 Emily Mackay (https://github.com/mackayem)
...
(function (global, factory) {
	...
	*/
	...
	//     if( $(window).width() < 768 ) {
	//         $("#em-headingEmailCTA").html("");
	//         $("#em-headingEmailCTA").html("Subscribe for <br>Tri-Local News");
	//     } else {
	//         $("#em-headingEmailCTA").html("");
	//         $("#em-headingEmailCTA").html("Subscribe for Tri-Local News");
	//     }
